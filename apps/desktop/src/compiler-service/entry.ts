...
import { serveCompilerOverMessagePort, type MessagePortLike } from '@abnt/protocol';
...
if (parentPort === undefined) {
  throw new Error('O Compiler Service precisa ser iniciado por um host Electron utility process.');
}

const compiler = criarServicoDeCompiler();
...
const unsubscribe = serveCompilerOverMessagePort(processPort, compiler);

...
export function ResearchWorkflowDialog({ workspaceId, onClose, onOpenDocument, onOpenPdf }: { readonly workspaceId: string; readonly onClose: () => void; readonly onOpenDocument: (fileId: string, path: string) => void; readonly onOpenPdf: (fileId: string, path: string, referenceId: string) => void }): JSX.Element {
